...
import {
    ...
    Memberships,
    GlobalAttributes,
    Genres, Authors, Publishers, Sessions, PrismaClient, BookInfo
} from "@prisma/client";
...
const createBooksMockData = async () => {
    ...
    const book3 = await prismaClient.bookInfo.create({
        data: {
            classNumber: "003",
            bookNumber: "B003",
            title: "Foundation",
    ...
    const book4 = await prismaClient.bookInfo.create({
        data: {
            classNumber: "004",
            bookNumber: "B004",
            title: "Dune",
    ...
    const book5 = await prismaClient.bookInfo.create({
        data: {
            classNumber: "005",
            bookNumber: "B005",
            title: "The Hobbit",
    ...
    const book6 = await prismaClient.bookInfo.create({
        data: {
            classNumber: "006",
            bookNumber: "B006",
    ...
    const book7 = await prismaClient.bookInfo.create({
        data: {
            classNumber: "007",
            bookNumber: "B007",
    ...
    const book8 = await prismaClient.bookInfo.create({
        data: {
            classNumber: "008",
            bookNumber: "B008",
            title: "1984",
    ...
    const book9 = await prismaClient.bookInfo.create({
        data: {
            classNumber: "009",
            bookNumber: "B009",
    ...
    const book10 = await prismaClient.bookInfo.create({
        data: {
            classNumber: "010",
            bookNumber: "B010",
